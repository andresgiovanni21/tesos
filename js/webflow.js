          ...
          function x(e, n) {
               ...
               return n = n || {}, e.find(':input:not([type="submit"])').each(function (r, a) {
                    ...
                    "string" == typeof c && (c = t.trim(c)), n[u] = c, i = i || function (t, e, n, i) {
                         var r = null;
                         "password" === e ? r = "Passwords cannot be submitted." : t.attr("required") && (i ? (d.test(n) || d.test(t.attr("type"))) && (h.test(i) || (r = "Please enter a valid email address for: " + n)) : r = "Please fill out the required field: " + n);
                         return r
                    }(o, s, u, c)
               }), i
          }
